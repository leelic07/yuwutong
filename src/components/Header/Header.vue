<template>
  ...
  <!--<header class="main-header">-->
    ...
    <!--<a href="index2.html" class="logo">-->
      ...
      <!--<span class="logo-mini"><b>狱务</b>管理</span>-->
      ...
      <!--<div class="navbar-custom-menu">-->
        <!--<ul class="nav navbar-nav">-->
          ...
          <!--<li class="dropdown user user-menu">-->
            <!--&lt;!&ndash; Menu Toggle Button &ndash;&gt;-->
            <!--&lt;!&ndash;<a href="#" class="dropdown-toggle" data-toggle="dropdown">&ndash;&gt;-->
              <!--&lt;!&ndash;&lt;!&ndash; The user image in the navbar&ndash;&gt;&ndash;&gt;-->
              <!--&lt;!&ndash;<img src="@/../dist/img/user2-160x160.jpg" class="user-image" alt="User Image">&ndash;&gt;-->
              <!--&lt;!&ndash;&lt;!&ndash; hidden-xs hides the username on small devices so only the image appears. &ndash;&gt;&ndash;&gt;-->
              <!--&lt;!&ndash;<span class="hidden-xs">Alexander Pierce</span>&ndash;&gt;-->
            <!--&lt;!&ndash;</a>&ndash;&gt;-->
            <!--<ul class="dropdown-menu">-->
